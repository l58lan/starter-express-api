...
const get_client_token = () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await fetch("https://dress-goshawk.cyclic.app/get_client_token", {
...
const client_id = "ATPgTWvLO2LxfA4norZMdVTJB52nU_Yfx7J8PN_z78SXB6Y462qkyOKI3yoYty2YZ8xYIt3eggN022rf";
const currency = "USD";
...
.then(() => {
    ...
    let paypal_buttons = paypal.Buttons({ // https://developer.paypal.com/sdk/js/reference
        ...
        createOrder: function(data, actions) { //https://developer.paypal.com/docs/api/orders/v2/#orders_create
            return fetch("https://dress-goshawk.cyclic.app/create_order", {
        ...
        onApprove: function(data, actions) {
            ...
            console.log(data);
            return fetch("https://dress-goshawk.cyclic.app/complete_order", {
                method: "post", headers: { "Content-Type": "application/json; charset=utf-8" },
                body: JSON.stringify({
                    "intent": intent,
                    "order_id": order_id
