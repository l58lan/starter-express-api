...
const endpoint_url = environment === 'production' ? 'https://api-m.paypal.com' : 'https://api-m.paypal.com';
...
function send_email_receipt(object) {
  const sendgrid_api_key = 'AcAe5JdNa5YrK2HR9CFluATZ89s3bwqvuno_fhMEOzM3JzbYAEhQTgeadfgnVbEJrLaZ20r7lep4j0IE';
